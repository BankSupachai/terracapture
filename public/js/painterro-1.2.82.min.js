            ...
            165: function(t, e, n) {
                ...
                var x = function() {
                    function t(e) {
                        ...
                        // console.log(this.baseEl, this.id, document.getElementById(this.id), 'ddd');
                        var r = "",
                            B = "";
                    ...
                    return e = t, (n = [{
                        ...
                        value: function(t, e, n) {
                            ...
                            void 0 !== e && (a = e);
                            var l = 1;
                            this.size.w > this.wrapper.documentClientWidth && (l = Math.min(l, this.wrapper.documentClientWidth / this.size.w)), this.size.h > this.wrapper.documentClientHeight && (l = Math.min(l, this.wrapper.documentClientHeight / this.size.h)), !this.zoom && this.zoomFactor > l && (this.zoomFactor = l);
                            var A = .2;
                            void 0 !== n && (A = n), this.zoomFactor += Math.sign(a) * A, this.zoomFactor < l ? (this.zoom = !1, this.zoomFactor = l) : this.zoom = !0, this.adjustSizeFull(), this.select.adjustPosition(), this.zoom && (this.scroller.scrollLeft = this.curCord[0] / this.getScale() - (o - this.wrapper.documentOffsetLeft), this.scroller.scrollTop = this.curCord[1] / this.getScale() - (i - this.wrapper.documentOffsetTop))
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            this.documentHandlers = {
                                ...
                                touchmove: function(e) {
                                    if (1 === e.touches.length) e.clientX = e.touches[0].clientX, e.clientY = e.touches[0].clientY, t.documentHandlers.mousemove(e);
                                    else if (2 === e.touches.length) {
                                        var n = (0, l.distance)({
                                                x: e.touches[0].clientX,
                                                y: e.touches[0].clientY
                                        ...
                                        e.clientX = r.x, e.clientY = r.y;
                                        var o = Math.abs(n - t.lastFingerDist),
                                            i = n > t.lastFingerDist ? 1 : -1;
                                        t.documentHandlers.wheel(e, i, !0, .001 * o), t.lastFingerDist = n, e.stopPropagation(), t.zoomButtonActive || e.preventDefault()
                                    }
                                },
                                ...
                                wheel: function(e, n, r, o) {
                                    t.shown && (void 0 !== r ? r : e.ctrlKey) && (t.zoomImage(e, n, o), e.preventDefault())
                                },
                                keydown: function(e) {
...
//# sourceMappingURL=painterro-1.2.82.min.js.map