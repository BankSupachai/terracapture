...
$video = $ffmpeg->open('../../store/'.$hn.'/'.$file);
...
//    ->save(new FFMpeg\Format\Video\WMV(), '../../store/'.$hn.'/'.$newfile[0].".wmv");
//    ->save(new FFMpeg\Format\Video\X264(), 'export-webm.avi');

     ->save(new FFMpeg\Format\Video\WebM(), '../../store/'.$hn.'/'.$newfile[0].".webm");


    $namenew = $newfile[0].".webm";
    $nameold = $file;

    header( "location: http://localhost/endocapture/public/renamevdo?namenew=".$namenew."&nameold=".$nameold );
    exit(0);
}
...
<body>
    <div id="vids">
        ...
        <source src="../../store/<?php echo $hn."/".$file;?>" type="video/mp4">
        </video>
