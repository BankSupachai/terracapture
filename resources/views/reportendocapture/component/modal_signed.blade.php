            ...
            <div class="modal-body px-3 pt-2">
                ...
                <div class="row">
                    <div class="col-6 mt-3">
                        <a href="javascript:;" id="create_sign_btn" class="btn btn-load btn-orange-custom w-100">Create/Edit Signature</a>

                    </div>
                    <div class="col-6 text-end">
                        <button type="button" id="confirm_signed_btn" id="confirm_signed"class="btn btn-load btn-primary me-3 mt-3 w-50" disabled>Confirm</button>
                    </div>
                </div>
            </div>
