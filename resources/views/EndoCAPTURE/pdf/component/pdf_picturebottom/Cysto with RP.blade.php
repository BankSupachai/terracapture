...
<table width="100%">
    ...
    <tr>
        <td><table>@include('endocapture.pdf.component.left_section.0015_GASTRICCONTENT')</table></td>
        <td><table>@include('endocapture.pdf.component.left_section.0018_RAPID_UREASE_TEST')</table></td>
    </tr>
    <tr>
