...
<table width="470px">
    ...
    <tr><td>@include('endocapture.pdf.component.left_section.0029_PRE-RIGID_BRONCHOSCOPY')</td></tr>
...
<table width="100%">
    <tr>
        ...
        <td style="vertical-align:top !important;"><table>@include('endocapture.pdf.component.left_section.0028_PROCEDURE_BRONCHO')</table></td>
    </tr>
    <tr>
