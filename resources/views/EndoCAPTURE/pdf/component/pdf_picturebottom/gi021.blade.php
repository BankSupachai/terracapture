...
<table border="0" height="600px;">
    <tr>
        <td>
            <img src="{{@$image_position[0]['name']}}" width="320px" height="240px" alt="" style="margin-top: 1.5em;">
        ...
        <td>
            <img src="{{@$image_position[1]['name']}}" width="320px" height="240px" alt="" style="margin-top: 1.5em;">
