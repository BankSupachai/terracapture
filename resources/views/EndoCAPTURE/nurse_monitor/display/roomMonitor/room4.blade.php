    ...
    <div class="card mb-2 " >
        <div class="bg-darkness px-1 pt-2" >
            <div class="col-12 p-0 text-end">
                <span class="fs-18">{{ $room->room_name }}</span>
                @php
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 " style="height: 330.5px; overflow:auto">
                        <div class="row p-2">
                            <div class="col-2 fs-18 fw-bold ">HN</div>
                            <div class="col-4 text-center fs-18 fw-bold">Name</div>
                            <div class="col-6 fs-18 fw-bold">Procedure</div>
                        </div>
                        ...
                        @forelse ($arr as $a)
                            ...
                            @endphp
                            <div class="row">
                                <div class="col-2 fs-18 text-nowrap"  style="color: #f7b84b">{{ $a->hn }}</div>
                                <div class="col-4 text-center fs-18 text-nowrap"  style="color: #f7b84b">{{ $a->patientname }}</div>
                                <div class="col-5">
                                    <div class="row ps-0 ms-0">
                                            @foreach ($a->procedure as $key => $value)
                                                <div class="col-7 ps-0 m-0 fs-18">{{ $value }}</div>
                                                <div class="col-5  fs-18 ">
                        ...
                        @empty
                            <div class="col-12 fs-18" style="text-align: center;">
                                No Operation !!
                            </div>
                        @endforelse
                            ...
                            @foreach ($arr as $a)
                                ...
                                <div class="@if (fmod($i, 2) == 1) bg-dark-tv  @endif p-1">
                                    <div class="row fs-18">
                                        ...
                                        <div class="col-2">
                                                <span class=" text-detail fs-18"  style="color: #f7b84b">{{ $a['hn'] }} &ensp;
                                            </span>
                                        </div>
                                        <div class="col-4">
                                            <span class=" text-detail fs-18"  style="color: #f7b84b"> {{ $patient }}
                                            </span>
                                        </div>
                                        <div class="col-4">
                                            <span class="text-detail fs-18">
                                                @foreach ($a['procedure'] as $key => $value)
                                                    {{ $value }}
                                                @endforeach
                                            </span>
                                        ...
                                        <div class="col-10 text-danger text-nowrap fs-18">
                                            {{ $a['prediagnostic'] }}
                                            @if ($a['remark'] != '')
                                                // {{ $a['remark'] }}
                                            @endif  &nbsp;
                    ...
                    <div class="col-12 mt-2">
                        <div class="row">
                            <div class="col-6">
                                {{-- <span class="fs-18">Endoscopist </span> --}}
                            ...
                            <div class="col-6 fs-18">
                                {{-- <span class="fs-18">Nurse and Practical</span> --}}
                                <div style="overflow: auto; overflow-x: hidden; height: 50px;">
                                    <div class="row m-0 fs-18">
                                        @php
