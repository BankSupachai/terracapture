...
<script>
    $(".btn_modal_discharged").click(function() {
        ...
        $.post("{{url("api/casemonitor")}}",{
            ...
            $("#data_id").val(data.tb_caseid)
           $("#data_hn").val(data.tb_casemonitor.monitor_hn)
            $("#patient_detail").html(`HN: ${data.tb_casemonitor.monitor_hn || ''} ${data.tb_casemonitor.monitor_patientname || ''} (${data.tb_case.age !== undefined && data.tb_case.age !== null ? data.tb_case.age : ''} Y) `);
