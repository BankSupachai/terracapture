...
<div class="col-6 px-1 ">
    <div class="card mb-2 " >
        <div class="bg-darkness px-1 pt-2" style="height: 94.5vh;">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 height-right-room2">
                        <div class="row p-2">
                    ...
                    <div class="col-12 mt-2">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="fs-16">Nurse and Practical 222</span>
...
{{-- <div class="col-6 px-1 ">
    <div class="card mb-2 " >
        <div class="bg-darkness px-3 pt-2" style="height: 100vh;">
            <div class="col-12 p-0 text-end">
                <span class="fs-16">Recovery room</span>
                @php
                    $arr    = operation_room($room->room_id);
                    $hn     = array();
                @endphp
