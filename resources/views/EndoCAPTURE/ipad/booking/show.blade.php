...
@section('tophead')
<a href="{{url("mockup/bookingipad")}}" class="mt-1">
            ...
            <div class="modal fade" id="event-modal" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0">
                        <div class="modal-header p-3 bg-dark-primary ">
                            {{-- <h5 class="modal-title text-white"
                            id="modal-title">Event</h5> --}}
                            <h5 class="modal-title text-white"
                            >Procedure</h5>
                            ...
                            <form class="needs-validation" name="event-form" id="form-event" novalidate>
                                ...
                                <div class="event-details">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <i class="ri-sticky-note-line text-white fs-16"></i>
                                        </div>
                                        <div class="flex-grow-1">
...
@section('script')
@include('endocapture.nurse_monitor.mockup.ipad.booking.calendar')
