                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ url('procedure') }}/{{ $case_id }}"
                                class="btn btn-info btn-label waves-effect right w-lg waves-light"><i
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <div class="h5 text-danger fw-light mt-2">
                            <div class="row">
                                <div class="col-6">
                                    <span><i class="ri-image-2-fill"></i> JPG, JPEG,PNG, TIFF, DICOM </span>
                                </div>
                                <div class="col-6">
