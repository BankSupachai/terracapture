<div class="modal fade" id="icd9_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-body" style="min-height: 40em;">
          <div id="chart_icd9_modal"></div>
        </div>
...
<script>
    ...
    var chart = am4core.create("chart_icd9_modal", am4charts.XYChart);
