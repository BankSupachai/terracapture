            ...
            <div class="card-body">
               ...
               @include('EndoCAPTURE.superadmin.component.menutopbar')
                ...
                <div class="row  " id="set_menu_config">
                    <div class="col-12">
                        <h3 class="text-primary">Cloud System</h5>
                    </div>
                    <div class="col-12">
                        &nbsp;
                    </div>
                    ...
                    <div class="col-6">
                        <div class="row m-0 ">
                            ...
                            <div class="col-6 text-center">
                                @component($swicth,["type"=>"cloud","name"=>"","id"=>"booking"])  @endcomponent
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="row m-0">
                            <div class="col-6 ">
                                <span class="h4">PDF to Cloud</span>
                            </div>
                            <div class="col-6 text-center">
                                @component($swicth,["type"=>"cloud"     ,"name"=>""          ,"id"=>"pdf2cloud"])  @endcomponent
                            </div>
                        </div>
