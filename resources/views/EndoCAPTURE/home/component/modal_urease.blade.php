    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{url('home')}}" method="post">
                @method('POST')
                @csrf
                <div class="modal-body p-3" style="border-top: 1px solid #E9EBEC;">
                    <p class="text-muted">Rapid Urease Test </p>
                    <div class="row p-3">
                        ...
                        <div class="col-4">
                            <div class="form-check form-radio-primary mb-3">
                                ...
                                <label class="form-check-label" for="urease_positive">
                                &ensp; Positive (+)
                                </label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-check form-radio-primary mb-3">
                                ...
                                <label class="form-check-label" for="urease_negative">
                                    &ensp;  Negative (-)
                                </label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-check form-radio-primary mb-3">
                                ...
                                <label class="form-check-label" for="urease_pending">
                                    &ensp;  Pending
                                </label>
                            </div>
                        </div>
                        <div class="col-12">
                            <input id="urease_text" name="urease_text" type="text" placeholder="Freetext" class="form-control w-100">
                        </div>
                        <div class="col-12 text-end mt-3">
                            <button type="submit" class="btn btn-primary btn-label waves-effect right waves-light"><i class="ri-check-double-line label-icon align-middle fs-16"></i> Confirm</button>
                        </div>
                    </div>
                </div>
        </form>
