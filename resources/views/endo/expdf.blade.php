    ...
    <div class="row" style="margin: 0;margin-top:0.5em;">
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-body" style="padding: 1em;">
                    @isset($_GET['caseid'])
                    REPORT <a href="{{ url('api/pdf?id='.$_GET['caseid']) }}" target="_blank">PDF</a>
                    @else
                    REPORT
                    @endisset
                    ...
                    @if (isset($_GET['type']))
                        ...
                        @if($tb_case!=null)
                            ...
                            @else
                                ...
                                <iframe id="iframepdf"
                                    src="http://{{getCONFIG('admin')->server_name}}:{{$portnumber}}/endocapture/public/pdf?id={{ $tb_case->caseuniq }}&type=Procedure{{ $savepdf }}"
                                    width="100%" height="1200"></iframe>
                                <label class="col-12"></label>
                            @endif
                        @endif
                    ...
                    @if (isset($_GET['path']))
                        <br><br>
                        <iframe id="iframepdf" src="{{url("api/pdf/endosmart?path={{$_GET['path']}}")}}"
