...
@section('modal')
 <!-- Default Modals -->
<div id="confirm_rollback_modal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted">Do you want to restore these cases?</p>
            </div>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-4">
                <a class="btn btn-success m-0" href="{{url('admin/case')}}" >Back</a>
            </div>
        </div>
        <div class="row m-0">
        </div>
        ...
        <div class="row m-0">
            ...
            <form action="{{url('admin/case/rollback')}}" method="put">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="{{url('admin/case/rollback')}}" type="button" class="btn btn-primary bg-gradient waves-effect waves-light">Clear</a>
                    </div>
                </div>
            </form>
...
<div class="card">
    <form action="{{url('admin/case')}}" method="post" id="rollback_cases_form">
        @csrf
        <input type="hidden" name="event" value="rollback_cases">
            ...
            <div class="col-lg-4">
                <div class="row">
                    ...
                    <div class="col-8 my-2">
                        ...
                        <button class="btn btn-danger ms-2" id="call_modal_btn" type="button" data-bs-toggle="modal" data-bs-target="#confirm_rollback_modal">Restore</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @isset($cases)
                        @foreach ($cases as $index=>$c)
                            ...
                            <tr class="tr-row" data-caseuniq="{{@$c->caseuniq}}" style="cursor: pointer">
                                <td>
                                    <input type="checkbox" class="form-check-input ck-case" name="rollback_ck[]" id="ck{{@$c->caseuniq}}" value="{{$c->caseuniq}}" data-caseuniq="{{$c->caseuniq}}">
                                </td>
