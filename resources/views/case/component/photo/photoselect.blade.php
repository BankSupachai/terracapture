                            ...
                            <div id="divselect{{ $photo['nu'] }}"
                                ...
                                <div class="row ps-2 pt-1">
                                    <div class="row left-menu" style="height: auto;">
                                        <div class="col-12">
                                            <span class="text-number-pic">{{ $select_order }}</span>
                                        </div>
                                        <div class="col-12 mt-2">
                                            <a class="btn-left-menu zoomify_icon_select " pic_number="{{ $photo['nu'] }}"
                                                photo_id2="{{ $photo['nu'] }}"
                                        ...
                                        <div class="col-12 mt-1">
                                            <a class="btn-left-menu-2 imgselect_new" style="color: #495057"
                                                ...
                                                <i class="ri-close-fill ri-lg" style="color:red;"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <img id="imgselect{{ $photo['nu'] }}" class="img-thumbnail-select"
...
@if (@$admin->system_autotext == 'true')
    <script>
        $('.photo_autotext').on('click keyup', function() {
            ...
            // alert('autotextcountpress');
            console.log(selectmainsub);
            console.log(autotextsystem)
            console.log(autotextcountpress);
            if (autotextcountpress < 10 && autotextsystem == "true") {
                console.log("mmmmmmm")

                $.post("{{ url('api/photo') }}", {
                    event: 'jqinputdropdown',
                    // textid: 'mainsub' + selectmainsub,
                    textid: textid,
                    value: this_value,
                    procedure: "{{ $procode }}",
                }, function(data, status) {
...
<script>
    ...
    $('.bigpic-modal').on('click', function() {
        ...
        console.log(img_height, img_width, imgselect_new);
    ...
    $('.imgselect_new').click(function() {
        ...
        if (selectnum == 0) {
            ...
            // $('#imgselect'+photo_id).css({"border":"5px solid #0AB39C"});
    ...
    $('.img-thumbnail-select').on('contextmenu', function(e) {
        e.preventDefault();
        var photoname = $(this).attr('photoname');
        var hn = '{{ $case->case_hn }}';
        ...
        $.post("{{ url('api/photomove') }}", {
            ...
            d = new Date();
            picturepath = "{{ picurl('') }}" + hn + "/{{ $folderdate }}/" + photoname + "?" + d.getTime();
            $(e.target).attr("src", picturepath);
        });
    });
