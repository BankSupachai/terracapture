            ...
            <div class="row">
                <div class="col-xxl-6 pe-5">
                    <div class="row">
                        ...
                        @if ($case->procedurename == 'Colonoscopy' || $case->procedurename == 'Sigmoidoscopy')
                            <div class="row">
                                ...
                                <div class="col-12 set_col">
                                    <div class="row">
                                        <div class="col-12 ">
                                            <div class="row mt-3">
                                                <div class="col-3">
                                                    Gastric Content &ensp; &ensp; <i class="ri-equalizer-line"></i>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="col-12 pt-3">
                                            <textarea id='gastriccontent_other' name="gastriccontent_other" type="text" placeholder="Free text" rows="1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            @php
                                            $complication_array = is_array($complication) ? $complication : (empty($complication) ? [] : [$complication]);
                                            $check = in_array($box, $complication_array) ? 'checked' : '';
                                             @endphp
                                    ...
                                    <div class="col-12 " style="margin-top: 28px;">
                                        <textarea id='complication_other' name="complication_other" type="text" placeholder="Free text" rows="5"
                ...
                <div class="col-xxl-6">
                    <div class="row ">
                        ...
                        @if ($procedure->name == 'EGD' || $procedure->name == 'Push Enteroscope' || $procedure->name == 'PEG')
                            <div class="col-12 set_col pt-3">
                                <div class="row">
                                    <div class="col-3">
                                        Rapid Urease Test &ensp; &ensp; <i class="ri-equalizer-line"></i>
                                    </div>
                                    <div class="col-auto">
                                    ...
                                    <div class="col-12 mt-3">
                                        <input class="form-control autotext savejson fs-13" id="rapid_other"
                                            placeholder="Free Text" type="text" autocomplete="off"
                            ...
                            <script>
                                ...
                                $(".rapid_urease_test").click(function() {
                                    ...
                                    if (radioId == "box_rapid_pending") {
                                        val = "Pending  [  ]  Positive     [  ]  Negative";
                                    }
                        ...
                        @if ($procedure->name == 'ERCP' || $procedure->name == 'EGD' || $procedure->name == 'Colonoscopy')
                            <div class="col-3 mt-3 align-self-center text-nowrap">
                                Estimate Blood Loss &ensp; &ensp; <i class="ri-equalizer-line "></i>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-5 mt-1 ms-2">
                                <input class="form-control autotext savejson" id="specimen1" placeholder="Detail"
                                    type="text" autocomplete="off" value="{{ @$case->specimen1 }}" />
                            </div>
                            <div class="col-2 mt-1 ">
                                <input id="specimenbottle1" value="{{ @$case->specimenbottle1 }}" type="number"
                                    class="form-control savejson">
                            </div>
                            <div class="col-1 mt-1 align-self-center">botton</div>

                            <div class="col-3 mt-1 "></div>
                            <div class="col-5 mt-1  ms-2">
                                <input class="form-control autotext savejson" id="specimen2" placeholder="Detail"
                                    type="text" autocomplete="off" value="{{ @$case->specimen2 }}" />
                            </div>
                            <div class="col-2 mt-1"><input id="specimenbottle2"
                                    value="{{ @$case->specimenbottle2 }}" type="number"
                                    class="form-control savejson"></div>
                            <div class="col-1 mt-1 align-self-center">botton</div>
                            <div class="col-3 mt-1 "></div>
                            <div class="col-5 mt-1  ms-2">
                                <input class="form-control autotext savejson" id="specimen3" placeholder="Detail"
                                    type="text" autocomplete="off" value="{{ @$case->specimen3 }}" />
                            </div>
                            <div class="col-2 mt-1"><input id="specimenbottle3"
                                    value="{{ @$case->specimenbottle3 }}" type="number"
                                    class="form-control savejson"></div>
                            <div class="col-1 mt-1 align-self-center">botton</div>
                            <div class="col-3 mt-1 "></div>
                            <div class="col-5 mt-1  ms-2">
                                <input class="form-control autotext savejson" id="specimen4" placeholder="Detail"
                                    type="text" autocomplete="off" value="{{ @$case->specimen4 }}" />
                            </div>
                            <div class="col-2 mt-1"><input id="specimenbottle4"
                                    value="{{ @$case->specimenbottle2 }}" type="number"
                                    class="form-control savejson"></div>
                            <div class="col-1 mt-1 align-self-center">botton</div>
                        ...
                        {{--
                            ...
                            <div class="col-2 mt-1"><input id="specimenbottle4"
                                    value="{{ @$case->specimenbottle4 }}" type="number"
                                    class="form-control savejson"></div>
                            <div class="col-1 mt-1 align-self-center">Bottle</div> --}}
                    ...
                    <div class="col-12">&nbsp;</div>
                    {{-- <div class="col-3 align-self-center">Urgent &ensp; &ensp; <i class="ri-equalizer-line"></i>
                        </div>
                        <div class="col-5">
                            <select name="urgent" id="urgent" class="form-select">
                                <option value="N/A" @selected(@$case->urgent == 'N/A')>N/A</option>
            ...
            <div class="col-xxl-6">
                <div class="row ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 mt-1"><input id="specimenbottle2" value="{{ @$case->specimenbottle2 }}"
                                type="number" class="form-control savejson"></div>
                        <div class="col-1 mt-1 align-self-center">Bottle</div>
                        ...
                        <div class="col-2 mt-1"><input id="specimenbottle3" value="{{ @$case->specimenbottle3 }}"
                                type="number" class="form-control savejson"></div>
                        <div class="col-1 mt-1 align-self-center">Bottle</div>
                        <div class="col-3 mt-1"></div>
                        <div class="col-5 mt-1 ms-2">
                        ...
                        <div class="col-2 mt-1"><input id="specimenbottle4" value="{{ @$case->specimenbottle4 }}"
                                type="number" class="form-control savejson"></div>
                        <div class="col-1 mt-1 align-self-center">Bottle</div>
                    ...
                    <div class="col-4">
                        <select name="urgent" id="urgent" class="form-select">
                            <option value="N/A" @selected(@$case->urgent == 'N/A' || @$case->urgent == '')>N/A</option>
                    ...
                    @if (@$project_name == 'capture')
                        <div class="row">
                            <div class="col-3 align-self-center">Follow Up &ensp; &ensp; <i
                                    class="ri-equalizer-line"></i>
                            </div>
                            <div class="col-5 ">
                                <input class="form-control  autotext savejson" id="followup_detail"
                                    placeholder="Detail" type="text" autocomplete="off"
                                    value="{{ @$case->followup_detail }}" />
                            </div>
                            <div class="col-1">
                            ...
                            <div class="col-2">
                                <select class="form-select form-select-sm" id="followup_unit">
                                    <option value="days" @selected(@$case->followup_unit == 'days')>Days</option>
                                    <option value="months" @selected(@$case->followup_unit == 'months')>Months</option>
                                    <option value="year" @selected(@$case->followup_unit == 'year')>Year</option>
                                </select>
                            </div>
                        ...
                        @else
                            ...
                            <div class="col-2">
                                <input type="number" class="form-control form-control-sm savejson"
                                    id="followup_date"
                                    value="{{ isset($case->followup_date) ? $case->followup_date : 0 }}">
                            </div>
