       <div class="row">
                       ...
                       <div class="row mt-2">
                           ...
                           <div class="form-group col-md-3 set-0">
                               <input id="medi{{ $medi->name }}" type="number" name="medigroup"
                                   ...
                                   value="{{ @$case->medication_unit[$medi->name]['dose'] }}" placeholder="Dose">
           ...
           @if(@$case->case_procedurecode == "gi005")
           <div class="row mt-3">
               <div class="col-4">
                   ENDOSCOPIC ROUTE
               </div>
               <div class="col-8">
                   <select name="route" id="route" class="form-select savejson">
                       <option value=""></option>
                       <option value="nose" @selected(@$case->route == "nose")>Nose</option>
                       <option value="oral" @selected(@$case->route == "oral")>Oral</option>
                       <option value="tracheostomy tube" @selected(@$case->route == "tracheostomy tube")>Tracheostomy tube</option>
                       <option value="Endotracheal tube" @selected(@$case->route == "Endotracheal tube")>Endotracheal tube</option>
                   </select>
               </div>
           </div>
          @endif
        @if (@$case->case_procedurecode == 'gi002' && @$project_name != 'capture')
            <div class="row">
                <div class="col-12 pt-4">
                   <b>Scope Pass Through</b>
                </div>
                <div class="col-12">
                    <div class="form-check mt-4 ms-1">
                        <input class="form-check-input savejson_checkbox" type="checkbox" name="scope_terminal" value="Terminal ileum" id="scope_terminal"
                        @checked(@$case->scope_terminal)>
                        <label class="form-check-label" for="scope_terminal">
                            Terminal ileum
                        </label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-check mt-3 ms-1">
                        <input class="form-check-input savejson_checkbox" type="checkbox" name="scope_cecum" value="Cecum" id="scope_cecum"
                        @checked(@$case->scope_cecum)>
                        <label class="form-check-label" for="scope_cecum">
                            Cecum
                        </label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-check mt-3 ms-1">
                        <input class="form-check-input savejson_checkbox" type="checkbox" name="scope_ascending" value="Ascending Colon" id="scope_ascending"
                        @checked(@$case->scope_ascending)>
                        <label class="form-check-label" for="scope_ascending">
                            Ascending Colon
                        </label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-check mt-3 ms-1">
                        <input class="form-check-input savejson_checkbox" type="checkbox" name="scope_transverse" value="Transverse Colon" id="scope_transverse"
                        @checked(@$case->scope_transverse)>
                        <label class="form-check-label" for="scope_transverse">
                            Transverse Colon
                        </label>
                    </div>
                </div>
