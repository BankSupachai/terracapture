...
<script>
    $('.savejson_checkbox').focusout(function() {
        ...
        if ($(this).is('select')) {
            ...
            if (select_value && select_value !== '') {
                value = select_value; // Send as string, not array
            } else {
                value = '';
            }
        }
        ...
        if ($(this).is('input[type="text"]')) {
            ...
            if (text_value && text_value !== '') {
                value = text_value; // Send as string, not array
            } else {
                value = '';
            }
        }
        ...
        if ($(this).is('textarea')) {
            ...
            if (textarea_value && textarea_value !== '') {
                value = textarea_value; // Send as string, not array
            } else {
                value = '';
            }
        }
    ...
    // Handle checkbox change events for savejson_checkbox
...
<script>
    function save_storage(this_name, value) {
        $.post('{{ url('api/jquery') }}', {
            event: 'savejson_checkbox2',
            idhtml: this_name,
            value: value,
