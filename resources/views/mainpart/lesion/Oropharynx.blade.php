        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-5">
                    <div class="row">
                        <div class="col-4">
                            {!! advance_text($mainpart, $num,$text, 'Kudo type') !!}
                        </div>
                        <div class="col-4">
                            {!! advance_text($mainpart, $num,$text, 'Sano type') !!}
                        </div>
                        <div class="col-4">
                            {!! advance_text($mainpart, $num,$text, 'NICE class') !!}
                        </div>
                ...
                <div class="col-7">
                    <div class="row">
                        <div class="col-3">
                            {!! advance_text($mainpart, $num,$text, 'JNET class') !!}
                        </div>
                        <div class="col-9">
                    ...
                    @foreach ($photo as $photo_key => $photo_val)
                        <div class="col-2">
                            <img src="{{ mePHOTO($case->hn, $photo_key, $case->appointment_date) }}?a={{ RandomString() }}"
                                alt="" class="img" width="200px" height="200px">
