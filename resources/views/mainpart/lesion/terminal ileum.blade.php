        ...
        <div class="card-body">
                    ...
                    @foreach ($photo as $photo_key => $photo_val)
                        <div class="col-2 text-center">
                            ...
                            <input type="text" class="form-control advance_phototext mt-2" placeholder="freetext"
                                value="{{ @$photo_val['text'] }}" mainpart="{{ $mainpart }}"
                                lesion="{{ $num }}" photo="{{ $photo_key }}">
                        </div>
                    @endforeach
            ...
            <div class="row mt-2">
                <div class="col-12 text-end">
                    <a href="{{ url("selectphoto/$case->id") }}?mainpart={{ $value }}&lesion={{ $num }}"
                        class="btn btn-primary ">Select photo</a>
                </div>
            </div>
        </div>
    </div>
