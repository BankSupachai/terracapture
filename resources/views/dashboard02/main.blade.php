...
<div class="row m-0 pt-2 fs-12" style="">
    <div class="col-lg-auto w-16">
        <div class="row ">
            @include('dashboard02.01_totalcase')
    ...
    <div class="col-lg-10 p-0" >
        <div class="row">
            @include('dashboard02.05_fillter')
        </div>
        <div class="row mb-2">
            @include('dashboard02.06_procedure')
            @include('dashboard02.07_treatment')
            @include('dashboard02.08_agegender')
            @include('dashboard02.09_diagnosis')
            @include('dashboard02.10_intervention')
            @include('dashboard02.11_complication')
            @include('dashboard02.12_physician')
...
<script>
    function to_url(type) {
        ...
        url           = `{{url('chdashboard')}}/${type}?date_from=${date_from}&date_to=${date_to}&physician=${physician}&procedure=${procedure}`
        location.href = url
    }
</script>
@endsection
