            ...
            <div class="card m-0" >
                <div class="card-header">
                    <div class="row p-0 m-0">
                        ...
                        @php
                            $physician_arr = isset($physician_data) ? $physician_data : [];
                            foreach ($physician_arr as $key => $value) {
                                if($value == 0){
                                    unset($physician_arr[$key]);
                                }
                            }
                        @endphp
                        <div class="col-lg-4 text-center">
                            <span class="text-header-fullchart">Physician</span>
                        </div>
                        <div class="col-lg-4">
