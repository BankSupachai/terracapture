        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="px-2">
                    <div class="col-12 d-flex justify-content-between">
                        <span class="h5 font-blue " id="patient_detail">HN : Suratchanut Chitrat (29 y 2 m) </span>
                    </div>
                    <span class="h5 font-blue">Contact : 091-232-3452</span>
                </div>
            ...
            <form action="{{ url('casemonitor') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-label waves-effect right waves-light w-lg btn-discharge"><i
