        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xxl-6 ">
                    <div class="row">
                        <div class="col-12">
                            <span class="h5">Post-Procedure (Diagnostic)</span> &ensp;
                            <button type="button" class="btn btn-transparent" id="modal_icd10"><i class="ri-equalizer-line"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                                        ...
                                        <div class="col-6">
                                            <label class="form-check-label checkbox checkbox-index">
                                                <input type="checkbox" name="diagnostic"
                                                    ...
                                                    id="boxicdten_{{ $i }}"
                                                    value="{{ $dia['name'] }}"
                                                    @if (in_array($dia['name'], isset($case->diagnostic) ? $case->diagnostic : [])) checked @endif>
                                                <span></span>
                                                <label class="ms-4"
                        ...
                        <div class="col-11" style="margin-top:15px;">
                            <textarea id='overall_diagnosis' name="formsubmit_overall_diagnosis" type="text" placeholder="Free text" rows="6"
                                autocomplete="off" class="savejson form-control autotext">{{ @$case->overall_diagnosis }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-6">
                    <div class="row pd_col">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <input
                                    ...
                                    name="formsubmit_diagnostic_text[]"
                                    txtnum="0"
                                    value="{{ @$case->diagnostic_text[0] }}"
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                <input type="text"
                                id="diag{{md5("case->diagnostic_text[1]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"
                                placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="1" value="{{ @$case->diagnostic_text[1] }}"
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                <input type="text"
                                id="diag{{md5("case->diagnostic_text[2]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"
                                 placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="2" value="{{ @$case->diagnostic_text[2] }}"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2" autocomplete="off">
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                ...
                                id="diag{{md5("case->diagnostic_text[3]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"

                                placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="3" value="{{ @$case->diagnostic_text[3] }}"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2 "autocomplete="off">
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                ...
                                id="diag{{md5("case->diagnostic_text[4]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"


                                placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="4" value="{{ @$case->diagnostic_text[4] }}"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2"autocomplete="off">
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                <input type="text"
                                id="diag{{md5("case->diagnostic_text[5]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"


                                placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="5" value="{{ @$case->diagnostic_text[5] }}"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2"autocomplete="off">
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                <input type="text"
                                id="diag{{md5("case->diagnostic_text[6]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"


                                placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="6" value="{{ @$case->diagnostic_text[6] }}"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2"autocomplete="off">
                        ...
                        <div class="col-12 mt-2">
                            <div class="input-group">
                                <input type="text"
                                id="diag{{md5("case->diagnostic_text[7]")}}"
                                group="diagnostic"
                                class="form-control texticd10 autotextgroup"


                                placeholder="Other Diagnosis"
                                    name="formsubmit_diagnostic_text[]" txtnum="7" value="{{ @$case->diagnostic_text[7] }}"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2"autocomplete="off">
