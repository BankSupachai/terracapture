...
<div class="row m-0  justify-content-center">
    <ul class="nav nav-pills arrow-navtabs nav-success bg-light mb-2" role="tablist">
        ...
        @if (@$feature->physician_record)
            <li class="nav-item ">
                <a class="nav-link nav-size  @if (@$tapactive == 'physicianrecord') active @endif" style="background-color: #0ab39c;" href="{{ url('procedure') }}/{{ $cid }}">
        ...
        <li class="nav-item ">
            <a class="nav-link nav-size  @if (@$tapactive == 'store') active @endif" s href="{{ url('store') }}/{{ $cid }}">
                <span class="d-block d-sm-none"><i class="mdi mdi-email"></i></span>
