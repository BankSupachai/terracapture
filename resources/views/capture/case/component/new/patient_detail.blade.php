...
@endphp
<div class="row" style="padding-right: 0 ; padding-left: 24px;">
        ...
        <div class="row p-4">
            <div class="col-4 img-with-btn-res text-center">
                ...
                <a href="{{ url('patient/' . @$patient->id . '/edit?type=procedure&cid=' . @$case->id) }}"
                    {{-- <a href="{{ url('patient/' . @$patient->_id . '/edit?prepage=') }}{{ url()->full() }}" --}} {{-- <a href="{{ url('patient/create') }}" --}} class="btn btn-editp btn-sm mt-3">Edit Profile</a>
            </div>
            <div class="col-8">
    ...
    <div class="col-xl-9" style="padding-right: 0">
        <div class="card p-2 mb-2">
            ...
            <div class="row">
                <div class="{{ count($otherprocedure) > 0 ? 'col-4' : 'col-5' }}">
                    <div class="row p-3">
                        <div class="col-12">
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control savejson autotext" placeholder="Refer"
                                        id="refer" name="refer" value="{{ @$case->refer }}"
                                        autocomplete="off">
                                </div>
                            </div>
                        </div>
                    ...
                    @if (count(@$otherprocedure) > 0)
                        <div class="col-2 mt-4" style="height: 118px; overflow-y: auto;">
                            ...
                            @foreach (isset($otherprocedure) ? $otherprocedure : [] as $data)
                                ...
                                @endphp
                                <div class="col-12">
                                    <a href="{{ url("capture/loadpic/$data->id") }}"
                ...
                <div class="col-2 p-0" style="text-align: -webkit-center;">
                    ...
                    <a class="btn btn-soft-success  w-75 mt-2 text-nowrap d-block"
                        href="{{ url("capture/$case->id") }}">
