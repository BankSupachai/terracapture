<!doctype html>
<html lang="en" data-layout="horizontal" data-layout-style="" data-sidebar="dark" data-layout-position="fixed"
    data-topbar="dark">
    ...
    <style>
        ...
        * {
        ...
        :root {
            ...
            --vz-header-bg: #ffffff;
            --vz-header-bg-dark: #ffffff;
            --vz-topbar-user-bg-dark: #F3F3F9;
            --vz-footer-bg: #1E4971;
            --vz-body-bg: #F3F3F9;
            --vz-text: white;
            --vz-form-bg: #3A5B73;
        ...
        .form-control-dark2:active,
        .form-control-dark2:focus-visible {
            background: #3A5B73;
            color: var(--vz-text);
        }
        ...
        .btn-check:active+.btn-dark-terra,
        .btn-check:checked+.btn-dark-terra,
        .btn-dark-terra.active,
        .btn-dark-terra.dropdown-toggle.show,
        .btn-dark-terra:active {
            color: #fff;
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="d-flex">
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="{{url("home")}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{url("public/image/capture.png.")}}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{url("public/image/capture.png.")}}" alt="" height="100">
                                </span>
                            </a>
                            ...
                            <a href="{{url("home")}}" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ url('public/image/capture.png.') }}" alt="" height="108">
                                </span>
                            </a>
                        ...
                        @if(str_contains(Request::path(), 'history'))
                            <div class="mt-3 pt-3">
                                <a href="{{url('history')}}" class="btn btn-another"> <i class="ri-arrow-left-circle-line ri-lg"></i> Another Patient</a>
                            </div>
                        @endif
                            ...
                            <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium ">{{uget("name")}}</span>
        ...
        <div class="main-content">
            ...
            <div class="page-content p-1">
                ...
                @include('capture.viewer.plugins')
