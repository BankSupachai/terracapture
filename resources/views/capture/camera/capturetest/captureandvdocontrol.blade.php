{{ bladelink('capture/camera/capturetest/captureandvdocontrol') }}
    ...
    <div class="col-12">
        <div class="col-12 d-flex justify-content-between align-items-center" style="height: 75px;">
            <div class="d-flex gap-2 mt-2">
                ...
                <button type="button"
                    class="btn btn-icon btn-back btn-white-camera waves-effect waves-light d-flex align-items-center justify-content-center"
