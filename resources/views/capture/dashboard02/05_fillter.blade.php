<div class="col-12 respondsive_dashboard">
    <div class="card center pb-3 ms-2" style="width: 1759px;">
        <div class="mt-3">
            <form action="{{ url('analysis') }}" method="POST">
                ...
                <div class="row d-flex align-items-center p-0 m-0">
                    ...
                    <div class="col-1">
                        ...
                        @endphp
                        <div>
                           <input id="date_from" name="date_from" type="text" onfocus="(this.type='date')"       onblur="(this.type='text')"  placeholder="Start-Date" class="form-control" value="{{@$filter_datefrom}}">
                        </div>
                    </div>
                    -
                    <div class="col-1">
                        ...
                        @endphp
                        <div>
                            <input id="date_to" name="date_to" type="text" class="form-control" type="text" onfocus="(this.type='date')"       onblur="(this.type='text')"  placeholder="End-Date" value="{{@$filter_dateto}}">
                        </div>
                    </div>
                    {{-- <div class="col-1 text-center">
                        <h5>Physician</h5>
