        ...
        <div class="col-lg-12 p-0">
            <div class="card m-0" >
                <div class="card-header">
                    <div class="row p-0 m-0">
                        <div class="col-lg-4">
                            ...
                            <a href="{{url('analysis')}}?event=filter_search&{{$text}}"
                            class="btn btn-light">หน้าหลัก </a>
                        </div>
                        @php
                            $procedure_arr = isset($procedure_data) ? $procedure_data : [];
                        @endphp
                        <div class="col-lg-4 text-center">
                            <span class="text-header-fullchart">Procedure</span>
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="card-body p-0 ">
                    <div id="bar_procedure_all" data-colors='["--vz-success"]' class="apex-charts" dir="ltr"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var chart = new ApexCharts(document.querySelector("#bar_procedure_all"), options);
    chart.render();
</script>
