   ...
   {{-- @dd($tb_casemonitor['register']); --}}
        <div class="col-lg-12" id="context">
            <div class="row m-0">
                ...
                {{-- ห้ามลบ จนกว่าจะทำ superadmin booking เสร็จ --}}
                {{-- @include('capture.control.register') --}}
                @include('capture.control.holding')
                @include('capture.control.operation_and_reporting')
                @include('capture.control.recovery_and_discharge')
                @include('capture.control.hide_display')
