...
<html lang="en">
    ...
    <head><base href="">
        ...
        <style>
            ...
            .aside-menu .menu-nav > .menu-item:not(.menu-item-parent):not(.menu-item-open):not(.menu-item-here):not(.menu-item-active):last-child:hover > .menu-heading, .aside-menu .menu-nav > .menu-item:not(.menu-item-parent):not(.menu-item-open):not(.menu-item-here):not(.menu-item-active):last-child:hover > .menu-link {
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            @if(Request::segment(1) == "analytic" || Request::segment(1) == "mockup")
                            <div class="menu-data">
                                <div class="row m-0 h-100">
                                    <div class="col-lg-2 p-0 h-100"><a href="{{url('queue_analytic')}}"><button class="w-100 h-100 btn-sm text-light btn queue">EndoQUEUE</button></a></div>
                                    <div class="col-lg-2 p-0 h-100"><a href="{{url('analytic')}}"><button class="w-100 h-100 btn-sm text-light btn capture">EndoCAPTURE</button></a></div>
                                    <div class="col-lg-2 p-0 h-100"><a href="{{url('note_analytic')}}"><button class="w-100 h-100 btn-sm text-light btn note">EndoNOTE</button></a></div>
                                    <div class="col-lg-2 p-0 h-100"><a href="{{url('trackchart')}}"><button class="w-100 h-100 btn-sm text-light btn track">EndoTRACK</button></a></div>
                                    {{-- <div class="col-lg-2 p-0 h-100"><button class="w-100 h-100 btn-sm text-light btn store">EndoSTORE</button></div>
                                    <div class="col-lg-2 p-0 h-100"><button class="w-100 h-100 btn-sm text-light btn warm">EndoWARM</button></div> --}}
                                </div>
                            </div>
                            @endif
