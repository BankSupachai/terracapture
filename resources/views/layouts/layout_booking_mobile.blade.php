        ...
        <div class="footer">
            <div class="row m-0">
                <div class="col-3 text-center">
                    <a href="{{url('bookmobile')}}" class="icon-book">
                        <p class="mb-0 @if((Request::segment(1) == "bookmobile")&&(Request::segment(2)==null)) menu-select @endif"><i class="far fa-window-maximize icon-2x icon-book"></i></p>
                        Home
                    </a>
                </div>
                <div class="col-3 text-center">
                    <a href="{{url('bookmobile/create')}}" class="icon-book">
                        <p class="mb-0 @if((Request::segment(1) == "bookmobile")&&Request::segment(2) == "create") menu-select @endif"><i class="fas fa-plus-circle icon-2x icon-book"></i></p>
                        Create
                    </a>
                </div>
                <div class="col-3 text-center">
                    <a href="{{url('booksearch')}}" class="icon-book">
                        <p class="mb-0 @if(Request::segment(1) == "booksearch") menu-select @endif"><i class="fa fa-search icon-2x icon-book"></i></p>
                        Search
                    </a>
                </div>
                <div class="col-3 text-center">
                    <a href="{{url('booksetting')}}" class="icon-book">
                    <p class="mb-0 @if(Request::segment(1) == "booksetting") menu-select @endif"><i class="fas fa-cog icon-2x icon-book"></i></p>
                    Setting
                    </a>
                </div>
            </div>
