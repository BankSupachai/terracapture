    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed {{$menuleft}} subheader-enabled subheader-fixed aside-enabled aside-fixed body_light body_light" id="body_set">
		...
		<div class="d-flex flex-column flex-root">
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper pl-0" id="kt_wrapper">
					<div id="kt_header" class="header header-fixed" style="left: 0 !important;">
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                <div class="row" style="padding-left: 0;">
                                    <div class="col-12 pt-3" style="height: fit-content;">
                                        @yield('header_b')
                                        <a href="{{url('book')}}" id="menu_home_logo">
                                            <img alt="Logo" src="{{url('public/image/EndoBOOK.png')}}" style="height:3.5em;"/>
                                        </a>
                                    </div>
                                </div>
							</div>
