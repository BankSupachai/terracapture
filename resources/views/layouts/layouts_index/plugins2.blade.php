<script>
    (document.querySelectorAll("[toast-list]") || document.querySelectorAll("[data-choices]") || document
        .querySelectorAll("[data-provider]")) && (document.writeln(
            "<script type='text/javascript' src='{{url("assets/js/toastify.js")}}'><\/script>"), document
        .writeln(
            "<script type='text/javascript' src='{{url("assets/libs/choices.js/public/assets/scripts/choices.min.js")}}'><\/script>"
            ), document.writeln(
            "<script type='text/javascript' src='{{url("assets/libs/flatpickr/flatpickr.min.js")}}'><\/script>"
            ));
</script>
