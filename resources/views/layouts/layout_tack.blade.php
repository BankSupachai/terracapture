...
<html lang="en">
    <head><base href="">
		...
		<script>var KTAppSettings = { "breakpoints": { "sm": 576, "md": 768, "lg": 992, "xl": 1200, "xxl": 1400 }, "colors": { "theme": { "base": { "white": "#ffffff", "primary": "#3699FF", "secondary": "#E5EAEE", "success": "#1BC5BD", "info": "#308199", "warning": "#FFA800", "danger": "#F64E60", "light": "#E4E6EF", "dark": "#181C32" }, "light": { "white": "#ffffff", "primary": "#E1F0FF", "secondary": "#EBEDF3", "success": "#C9F7F5", "info": "#308199", "warning": "#FFF4DE", "danger": "#FFE2E5", "light": "#F3F6F9", "dark": "#D6D6E0" }, "inverse": { "white": "#ffffff", "primary": "#ffffff", "secondary": "#3F4254", "success": "#ffffff", "info": "#ffffff", "warning": "#ffffff", "danger": "#ffffff", "light": "#464E5F", "dark": "#ffffff" } }, "gray": { "gray-100": "#F3F6F9", "gray-200": "#EBEDF3", "gray-300": "#E4E6EF", "gray-400": "#D1D3E0", "gray-500": "#B5B5C3", "gray-600": "#7E8299", "gray-700": "#5E6278", "gray-800": "#3F4254", "gray-900": "#181C32" } }, "font-family": "Poppins" };</script>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed body_light aside-minimize  body_light" id="body_set">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					<div class="brand flex-column-auto" id="kt_brand">
						{{-- <a href="{{url("")}}" class="brand-logo">
							<img alt="Logo" src="{{url("")}}/public/image/logo_tack.png" style="max-width: 180px;"/>
						</a> --}}
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper" style="background: #308199;">
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="background: #308199;">
							<ul class="menu-nav">
                                <li class="menu-item menu-pc @if(Request::segment(1) == "track" && Request::segment(2) != "create") menu-item-active @endif" aria-haspopup="true" id="menu_homes">
                                ...
                                <li class="menu-item menu-ipad @if(Request::segment(1) == "track" && Request::segment(2) != "create") menu-item-active @endif" aria-haspopup="true" id="menu_homes">
                                ...
                                <li class="menu-item @if(Request::segment(2) == "create") menu-item-active @endif" aria-haspopup="true" id="menu_details">
                                    <a href="{{url("track/create")}}" class="menu-link">
                                        <i class="fas fa-align-justify icon-lg"></i>
										<span class="menu-text"> &emsp;Scope List</span>
                                    </a>
                                </li>
                                {{-- <li class="menu-item @if(Request::segment(1) == "trackchart") menu-item-active @endif" aria-haspopup="true" id="menu_charts">
                                    <a href="{{url("")}}/trackchart" class="menu-link">
                                        <i class="fas fa-chart-line icon-lg"></i>
										<span class="menu-text"> &emsp;Charts</span>
                                    </a>
                                </li> --}}
                                {{-- <li class="menu-item @if(Request::segment(1) == "rfidcard") menu-item-active @endif" aria-haspopup="true" id="menu_charts">
                                    <a href="{{url("")}}/rfidcard" class="menu-link">
                                        <i class="fas fa-sd-card icon-lg"></i>
										<span class="menu-text"> &emsp;RFID</span>
                                    </a>
                                </li> --}}
							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                <div class="row" style="padding-left: 3em;">
                                    <div class="col-12 pt-3">
                                        <a href="{{url('track')}}">
                                            <img alt="Logo" src="{{url("public/image/logo_tack.png")}}"style="height:3.2em;" id="logo_pc"/>
                                            <img alt="Logo" src="{{url("public/image/endotrack_white.png")}}"style="height:3em;" id="logo_ipad"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <button type="button" onclick="call_right()" style="display: none">Call</button>
        @yield('script')
        <script>
            function new_color(id_menu,id_icon){
                $(id_menu).mouseenter(function () {
                $(id_icon).removeClass('svg-icon-light').addClass('svg-icon-info');
                });
                $(id_menu).mouseleave(function () {
                    $(id_icon).addClass('svg-icon-light').removeClass('svg-icon-info');
                    }
                ).mouseleave();
            }
            @if(Request::segment(1) != "tack_home")     new_color('#menu_homes'     ,'#menu_home');     @endif
            @if(Request::segment(1) != "tack_details")  new_color('#menu_details'   ,'#menu_detail');   @endif
            @if(Request::segment(1) != "tack_charts")   new_color('#menu_charts'    ,'#menu_chart');    @endif
        </script>
	</body>
</html>
