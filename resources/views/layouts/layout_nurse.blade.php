...
<html lang="en">
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed" id="body_set">
        @yield('modal')
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<a href="{{url("")}}">
				<img alt="Logo" src="{{url('public/image/logo_capture2.png')}}" style="max-width: 115px;"/>
			</a>
