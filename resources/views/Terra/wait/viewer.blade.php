    ...
    <div class="modal-dialog">
        <div class="modal-content card-body">
            ...
            <div class="modal-body">
                <input type="text" id="phone" name="" class="form-control form-control-dark mt-3" placeholder="Enter Phone number" autocomplete="off">
            </div>
            ...
            <div class="card-body">
                <div class="row m-0">
                    ...
                    <div class="col text-center">
                        ...
                        <br>
                        <button type="button" id="btn" onclick="check_hn()"  class="btn btn-terralink waves-effect w-25" disabled>Confirm</button>
