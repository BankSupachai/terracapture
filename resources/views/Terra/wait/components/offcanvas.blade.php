<div class="offcanvas-body">
    <div class="row justify-content-between">
        <div class="col-6">
            <ul class="nav nav-pills nav-success mb-3" role="tablist">
                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link active text-light" data-bs-toggle="tab" href="#report_viewer" id="btn_report" role="tab">Report</a>
                </li>
                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link text-light" data-bs-toggle="tab" href="#photo_viewer" id="btn_photo" role="tab">Photo</a>
                </li>
                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link text-light" data-bs-toggle="tab" href="#video_viewer" id="btn_video" role="tab">Video</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-4 " id="physician_select">
            <select id="pdf_type" class="form-select mb-3 form-terra" aria-label="Default select example" onchange="change_pdf('')">
