...
<body id="body">
    ...
    <!-- @include('capture.component.modal_editstatus')
    @include('capture.component.modalRegister')
    @include('capture.component.modalCancleCaseHn')
    @include('capture.component.modalroom')
    @include('capture.component.modal_patient')
    @include('capture.component.modal_discharge')
    @include('capture.component.modal_confirm_hide')
    @include('capture.component.modal_multi_confirm_hide')
    @include('capture.component.modal_confirm_show')
    @include('capture.component.modal_multi_confirm_show') -->
    ...
    <div class="row m-0 mb-5">
        <div class="col-lg-12">
            <div class="card mt-3 mb-0">
                <div class="card-body">
                     ...
                     <h4 class="mb-sm-0" style="font-weight: bold;">Case Monitor</h4>
                </div>
            </div>
        </div>
        <div class="col-12 mt-2">
            <div class="card p-3 mb-0">
                <?php include("casemonitor/search.php"); ?>
            </div>
        </div>
        ...
        <div class="col-lg-12" id="context">
            ...
            <!-- <?php include("casemonitor/booking_no_system.php"); ?> -->

                <?php include("casemonitor/holding.php"); ?>
                <?php include("casemonitor/operation_and_reporting.php"); ?>
                <?php include("casemonitor/recovery_and_discharge.php"); ?>
                <?php include("casemonitor/hide_display.php"); ?>
